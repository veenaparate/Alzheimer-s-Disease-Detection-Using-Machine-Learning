...
frame_alpr = tk.LabelFrame(root, text="  ", width=850, height=850, bd=5, font=('times', 14, ' bold '),bg="#271983")
frame_alpr.grid(row=0, column=0)
frame_alpr.place(x=750, y=0)

lbl = tk.Label(root, text="Alzheimer Disease detection", font=('Elephant', 35,' bold '),bg="White",fg="Black")
